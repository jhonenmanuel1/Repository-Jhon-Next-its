...
export default function Main() {
    ...
    <section class="text-gray-600 body-font">
      <div className=" flex  lmin:flex-col"  >
        ...
        <div class="max-w-5xl pt-52 pb-30 mx-auto">
          ...
          I manage different tools like<br/>
          Tailwind, CSS, NextJS, HTML, JavaScript, Sass and others. <br/>
          I'm very disciplined and I love programming<br/>
          and learning new things in this area.<br/>
  ...
  <rect width="100" height="330" fill="#f7df1e"/>
