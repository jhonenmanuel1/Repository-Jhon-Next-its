      ...
      >
        ...
        <div className="max-w-3xl  justify-end">
          ...
          <div class="ktq4 ">
            ...
            <p>Platzi</p>
            <p class="pt-2 value-text text-md text-gray-200 fkrr1">
              Expedición: may. 2022 · Sin fecha de vencimientoExpedición: may. 2022 · Sin fecha de vencimiento
              ID de la credencial f827d4fb-16d3-4611-a9d7-684ddcbdb92aID de la credencial f827d4fb-16d3-4611-a9d7-684ddcbdb92a
              Mostrar credencial
            </p>
            <a
              className="bg-white"
            ...
            <h3 class="pt-3 font-semibold text-lg text-white mt-5">
            EF SET English Certificate 46/100 (B1 Proficient)EF SET English Certificate 46/100 (B1 Proficient)
            </h3>
...
Expedición: mar. 2021 · Sin fecha de vencimiento
      ...
      <div className="pt-32 pb-32 max-w-6xl mx-auto fsac4 md:px-1 px-3">
        <div class="ktq4">
          ...
          <h3 class="pt-3 font-semibold text-lg text-white">
          Systems coordinator(Temporary job) – Agrimer C. A.(March/ 2022 May/2022):
          </h3>
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
           I worked as the systems coordinator doing maintenance to all the computers and electronic equipment 
of the company, I provided technical support to the Galact Software and Website of the company. I 
worked practically in all parts of the company making tools to improve the productivity. 
          </p>
        </div>
        <div class="ktq4">
          <img src="https://nine4.app/images/nine4-3.png"></img>
