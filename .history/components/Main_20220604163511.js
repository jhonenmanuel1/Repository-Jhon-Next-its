    ...
    <section class="text-gray-600 body-font">
      ...
      <div className="pt-32 pb-32 max-w-6xl mx-auto fsac4 md:px-1 px-3">
        <div class="ktq4">
          ...
          <h3 class="pt-3 font-semibold text-lg text-white">
            Systems coordinator IT SUPPORT (contracts) – Agrimer C. A.( September/2020 December/2020 // Feb/2021 April/2021  // March/ 2022
            May/2022):
          </h3>
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
        ...
        <div class="ktq4">
          ...
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
          I created transport, combos and clients Modules. I made sure that the printing options worked, and I 
also made some others modifications in the program like Bills module. I did this with React, and electron using some tools like bumbag, formik, axios, SQLite
          </p>
        </div>
      </div>
