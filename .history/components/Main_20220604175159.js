...
export default function Main() {
  return (
    <section class="text-gray-600 body-font">
      ...
      <div className=" flex flex-col items-center justify-center mx-auto pb-14"></div>
      <h2 className="pt-20 mb-1 text-2xl font-semibold tracking-tighter text-center text-gray-200 lg:text-7xl md:text-6xl pb-14">
        Work Experience
      </h2>
      <a
              data-v-54e46119=""
      ...
      <div className="pt-32 pb-32 max-w-6xl mx-auto fsac4 md:px-1 px-3 bg-gradient-to-r from-purple-800 via-purple-700 to-indigo-800">
        <div class="ktq4">
        ...
        <div class="ktq4">
          <img src="https://nine4.app/images/nine4-3.png"></img>
          <h3 class="pt-3 font-semibold text-lg text-white">
          Research Assistant – Universidad de los Andes-(August /2020 to Jan/2022 ):
          </h3>
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
          I collected and analyzed some economics Index of different parts of Latin-American. I also worked with 
