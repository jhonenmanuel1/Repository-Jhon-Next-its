    ...
    <section class="text-gray-600 body-font text-center ">
      <div className=" flex  lmin:flex-col">
        <div className=" pt-40 pb-15 mx-auto  ">
          ...
          jhonesantiagor@gmail.com

          </h3>
          
          <h3 className="text-white"> +584247287084</h3>
        ...
        <div class="max-w-5xl pt-52 pb-30 mx-auto">
          ...
          <div className="flex lmin:flex:column space-x-2 items-center justify-center  text-white text-center pb-16 relative">
            <div>
              <svg
