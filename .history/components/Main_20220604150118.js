    ...
    <section class="text-gray-600 body-font">
      ...
      <h2 class="text-4xl font-4 font-semibold  text-white text-left  ">
        ...
        <h2  class="text-2xl font-5  lh-6 ld-04 pb-11 pt-4 text-white text-left mx-auto" >
          ...
          Higher Technician Informatics, 2020 – Instituto Universitario de Tecnologia Cristobal Mendoza:
          </h3>
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
          Informatics Networks, Data Bases, Data Structures, Sowftware basics and Technical support.
          </p>
          <h3 class="pt-3 font-semibold text-lg text-white mt-5">
          Degree in economics, May 2018- Actually – Universidad de los Andes
          </h3>
          <p class="pt-2 value-text text-md text-gray-200 fkrr1">
          Informatics Networks, Data Bases, Data Structures, Sowftware basics and Technical support.
          </p>
