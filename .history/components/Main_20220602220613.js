...
export default function Main() {
  return (
    <section class="text-gray-600 body-font">
      ...
      <div className="  bg-gradient-to-r from-purple-800 via-fuchsia-900 to-black">
      <h1 class="text-3xl font-4 font-semibold lh-6 ld-04 pb-11 pt-11 text-white text-center">
            Experiencia 
          </h1>
        <div>
          <div>
