  ...
  return (
    <section class="text-gray-600 body-font">
      <div className="grid grid-cols-2" >
        <div>
          <img src="../img/32ff7550-1079-4891-b2f7-838a9fe2ef71.jpg" width={"100%"} height="100%"></img>
          <h1 class="text-80 text-center font-4 lh-6 ld-04 font-bold text-white mb-6 pt-52 pb">
            Create your 
          </h1>
        </div>
      ...
      <div className="container flex flex-col items-center justify-center mx-auto">
        <img
          ...
          src="/public/images/32ff7550-1079-4891-b2f7-838a9fe2ef71.jpg"
        ></img>
      </div>
