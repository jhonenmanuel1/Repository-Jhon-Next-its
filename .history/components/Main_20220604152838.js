      ...
      >
        ...
        <div className="max-w-3xl  justify-end">
          ...
          <div class="ktq4 ">
            ...
            <a className="bg-white" href="https://platzi.com/p/jhonesantiagor/curso/2690-nextjs-practico/diploma/detalle/"> Ver Certificado</a>
            <h3 class="pt-3 font-semibold text-lg text-white mt-5">
              Curso Práctico de Next.jsCurso Práctico de Next.js
            </h3>
            <p>Platzi</p>
            ...
            <a className="bg-white mt-" href="https://platzi.com/p/jhonesantiagor/curso/2690-nextjs-practico/diploma/detalle/"> Ver Certificado</a>
            <br/>
            <a
            data-v-54e46119=""
            ...
            target="_blank"
            className="pl-7 invisible md:visible justify-center items-center"
          >
           <button 
           className="
