...
export default function Main() {
  return (
    <section class="text-gray-600 body-font">
      ...
      "
      >
        <h2 class="text-4xl font-4 font-semibold lh-6 ld-04 pb-11 pt-11 text-white text-left mx-40">
          Educacion
        </h2>
        <div>
          <h2  class="text-4xl font-4 font-semibold lh-6 ld-04 pb-11 pt-11 text-white text-left mx-auto" >love</h2>
          <div>description</div>
        </div>
      </div>
